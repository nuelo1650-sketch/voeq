  ...
  return (
    <>
      <button
        ...
        className="sticky top-16 z-30 flex w-full items-center justify-between gap-2 border-b border-cream-200 bg-cream-50/95 px-6 py-2.5 backdrop-blur transition hover:bg-cream-100 dark:border-forest-700 dark:bg-forest-900/95 dark:hover:bg-forest-800"
      >
