      ...
      <Card>
        <CardContent className="space-y-4 pt-6">
          <div>
            ...
            <select value={to} onChange={(e) => setTo(e.target.value as 'all_users' | 'all_vendors')} className="mt-1 w-full rounded-md border border-cream-300 bg-cream-50 px-3 py-2 text-sm dark:border-forest-700 dark:bg-forest-800 dark:border-cream-100">
          ...
          <div>
            ...
            <textarea value={body} onChange={(e) => setBody(e.target.value)} rows={6} className="mt-1 w-full rounded-md border border-cream-300 bg-cream-50 px-3 py-2 text-sm dark:border-forest-700 dark:bg-forest-800 dark:border-cream-100" />
          </div>
