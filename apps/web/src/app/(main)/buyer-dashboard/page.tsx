...
export default async function BuyerDashboardPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-cream-200 bg-gradient-to-br from-forest-800 via-forest-900 to-forest-950 dark:border-forest-700">
          ...
          <div className="flex flex-col gap-4 py-10 sm:py-14">
            ...
            <div className="mt-2 flex flex-wrap gap-3">
              ...
              <Link href="/become-vendor">
                <Button variant="outline" size="lg" className="border-cream-100/30 text-cream-100 hover:bg-cream-100/10">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <Card className="opacity-70">
                <CardContent className="flex items-center justify-between pt-6">
                  ...
                  <span className="rounded-md bg-cream-200/70 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-forest-700/60 dark:bg-forest-700 dark:text-cream-100/60">
                    Soon
                  </span>
                </CardContent>
              </Card>
            ...
            {wishlistItems.length > 0 && (
              <div>
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Link href="/wishlist" className="inline-flex items-center gap-1 text-sm font-medium text-forest-700 hover:text-gold-600 dark:text-gold-500">
            ...
            {followingItems.length > 0 && (
              <div>
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Link href="/following" className="inline-flex items-center gap-1 text-sm font-medium text-forest-700 hover:text-gold-600 dark:text-gold-500">
                    View all <ArrowRightIcon className="h-4 w-4" />
                  </Link>
                </div>
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
