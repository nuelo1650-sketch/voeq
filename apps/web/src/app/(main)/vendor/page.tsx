...
import { ArrowRightIcon, ChevronRightIcon, CheckIcon, StarIcon, ShareIcon, EyeIcon, ChatIcon, TrendingUpIcon } from '@/components/icons';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-serif text-3xl font-semibold text-forest-900 dark:text-cream-100">{vendor.businessName}</h1>
          <div className="mt-1 flex items-center gap-2 text-sm text-forest-700/70 dark:text-cream-100/70">
            {isLive ? (
