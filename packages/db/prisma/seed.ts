...
const CATEGORIES: Array<{
  ...
  { slug: 'food', name: 'Food', iconName: 'utensils', displayOrder: 1, requiresDelivery: true, escrowDurationHours: 2, description: 'Meals, snacks, drinks, and food vendors on campus.' },
  { slug: 'fashion', name: 'Fashion', iconName: 'shirt', displayOrder: 2, requiresDelivery: false, escrowDurationHours: 24, description: 'Clothing, shoes, bags, and fashion accessories.' },
  { slug: 'tech', name: 'Tech', iconName: 'cpu', displayOrder: 3, requiresDelivery: true, escrowDurationHours: 24, description: 'Phones, laptops, gadgets, repairs, and tech services.' },
  { slug: 'beauty', name: 'Beauty', iconName: 'sparkles', displayOrder: 4, requiresDelivery: false, escrowDurationHours: 48, description: 'Makeup, hair, skincare, and beauty services.' },
  { slug: 'repairs', name: 'Repairs', iconName: 'wrench', displayOrder: 5, requiresDelivery: true, escrowDurationHours: 24, description: 'Phone, laptop, electronics, and general repairs.' },
  { slug: 'printing', name: 'Printing', iconName: 'printer', displayOrder: 6, requiresDelivery: true, escrowDurationHours: 2, description: 'Printing, photocopying, binding, and stationery.' },
  { slug: 'laundry', name: 'Laundry', iconName: 'shirt', displayOrder: 7, requiresDelivery: true, escrowDurationHours: 48, description: 'Laundry, dry cleaning, and ironing services.' },
  { slug: 'photography', name: 'Photography', iconName: 'camera', displayOrder: 8, requiresDelivery: false, escrowDurationHours: 48, description: 'Photography, videography, and editing services.' },
  { slug: 'academic-services', name: 'Academic Services', iconName: 'book', displayOrder: 9, requiresDelivery: false, escrowDurationHours: 48, description: 'Tutoring, assignment help, and academic support.' },
  { slug: 'logistics', name: 'Logistics', iconName: 'truck', displayOrder: 10, requiresDelivery: true, escrowDurationHours: 2, description: 'Delivery, errand running, and logistics services.' },
  { slug: 'furniture', name: 'Furniture', iconName: 'sofa', displayOrder: 11, requiresDelivery: true, escrowDurationHours: 24, description: 'Furniture, fittings, and home goods.' },
  { slug: 'health-wellness', name: 'Health and Wellness', iconName: 'heart', displayOrder: 12, requiresDelivery: false, escrowDurationHours: 24, description: 'Pharmacy, fitness, and wellness services.' },
  { slug: 'catering', name: 'Catering', iconName: 'utensils', displayOrder: 13, requiresDelivery: true, escrowDurationHours: 2, description: 'Event catering, bulk food, and party services.' },
  { slug: 'cleaning', name: 'Cleaning', iconName: 'spray-can', displayOrder: 14, requiresDelivery: false, escrowDurationHours: 48, description: 'Home, office, and hostel cleaning services.' },
  { slug: 'electrical', name: 'Electrical', iconName: 'zap', displayOrder: 15, requiresDelivery: false, escrowDurationHours: 24, description: 'Electrical work, wiring, and appliance services.' },
  { slug: 'plumbing', name: 'Plumbing', iconName: 'droplet', displayOrder: 16, requiresDelivery: false, escrowDurationHours: 24, description: 'Plumbing, pipework, and water services.' },
  { slug: 'tailoring', name: 'Tailoring', iconName: 'scissors', displayOrder: 17, requiresDelivery: false, escrowDurationHours: 48, description: 'Tailoring, fashion design, and alterations.' },
  { slug: 'supermarket', name: 'Supermarket', iconName: 'shopping-cart', displayOrder: 18, requiresDelivery: true, escrowDurationHours: 24, description: 'Groceries, provisions, and supermarket items.' },
  { slug: 'pharmacy', name: 'Pharmacy', iconName: 'pill', displayOrder: 19, requiresDelivery: true, escrowDurationHours: 24, description: 'Pharmacy, medication, and health products.' },
  { slug: 'other', name: 'Other', iconName: 'grid', displayOrder: 20, requiresDelivery: false, escrowDurationHours: 48, description: 'Anything else that does not fit a specific category.' },
];
